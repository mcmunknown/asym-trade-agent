...
# PATCH: Fix data alignment in get_calculus_signal method
def get_calculus_signal(self, symbol, prices):
    ...
    try:
        ...
        # Remove NaN values and ensure proper index
        ...
        print(f'Calculus signal error: {e}')
        return {
            'signal': 0,
            'confidence': 0.0,
            'velocity': 0.0,
